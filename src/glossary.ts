...
export const GLOSSARY: Record<string, GlossaryEntry> = {
  ...
  "study-map": {
    term: "项目地图",
    summary:
      "被学项目自己的架构分层，加上「你的课程走进过其中多少」。分层来自 Understand Anything 的分析，引用统计来自课程证据。",
    detail:
      "两边单独都答不了这个问题：UA 认识代码但不知道你学过什么，课程列表知道教了什么但不知道漏了什么。合起来才能指出「这一层几乎没人碰过」。注意它分不出「有意跳过」和「根本没想到」——生成产物和测试代码本来就不必逐个讲，它只负责告诉你位置。",
  },
  "ua-place": {
    term: "项目里的位置",
