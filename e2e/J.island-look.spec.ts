...
const ISLAND_LOOK_RATCHET: Readonly<Record<string, RatchetBaseline>> = {
  "course-design/desktop": {
    sceneLinearRange: 5.825,
    landMedianLightness: 50.5244,
    landP95Lightness: 75.2878,
    landLightnessRise: 24.7634,
    backgroundLightnessSpread: 32.293,
    grassLightnessSpread: 39.8258,
    grassLightnessP95: 76.2718,
    lightnessP2: 35.8535,
    lightnessP98: 78.5922,
    lightnessStdDev: 12.71,
    grassHueCount: 9,
    grassHueSpread: 120,
    accentArea: 0.0015,
    keyToFillRatio: 5.3608,
    domLabelContrastMin: 8.8868,
  ...
  "course-far/desktop": {
    ...
    landMedianLightness: 50.4215,
    landP95Lightness: 75.5239,
    landLightnessRise: 25.1024,
    backgroundLightnessSpread: 43.4949,
    grassLightnessSpread: 53.654,
    grassLightnessP95: 77.2241,
    lightnessP2: 23.0834,
    lightnessP98: 85.773,
    lightnessStdDev: 16.2052,
    grassHueCount: 9,
  ...
  "course-design/mobile": {
    ...
    backgroundLightnessSpread: 38.2893,
    grassLightnessSpread: 32.4114,
    grassLightnessP95: 78.4072,
    lightnessP2: 37.8218,
    lightnessP98: 82.9636,
    lightnessStdDev: 14.3485,
    grassHueCount: 9,
    grassHueSpread: 120,
    accentArea: 0.0905,
    keyToFillRatio: 5.3608,
  ...
  "course-far/mobile": {
    ...
    landMedianLightness: 52.6041,
    landP95Lightness: 80.8839,
    landLightnessRise: 28.2798,
    backgroundLightnessSpread: 31.9002,
    grassLightnessSpread: 49.4044,
    grassLightnessP95: 72.9974,
    lightnessP2: 22.7128,
    lightnessP98: 83.7498,
    lightnessStdDev: 16.4703,
    grassHueCount: 9,
    grassHueSpread: 120,
    accentArea: 0.0511,
    keyToFillRatio: 5.3608,
