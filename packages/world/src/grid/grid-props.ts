...
import { clusterGeometryHolds, GRID_CANOPY_SPACING } from "./grid-props-contract.js";
import {
  gridBiomesForUnits,
  gridNatureAspect,
  gridPropSize,
...
/**
 * Keep the historical grid-props entry point stable while the acceptance
 * gates live in their own discoverable module.
 */
export {
  GRID_CANOPY_SPACING,
  canopySpacingHolds,
  ...
  propClustersFitCells,
  propsAvoidRoute,
  visiblePropsNearRoute,
} from "./grid-props-contract.js";
