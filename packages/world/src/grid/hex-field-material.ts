...
export function createHexFieldMaterial(
  ...
  const gridEdgeRadius = 1 - seamStrength;
  const gridRimStrength = layer === "route" ? 0.18 : layer === "detached" ? 0.34 : 0.62;
