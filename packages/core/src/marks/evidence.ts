import type { EvidenceAnchorRange } from "../domain/lesson-marks.js";
import { parseLessonLinks, tokenKind, type ParsedLessonLink } from "./references.js";

export type { EvidenceAnchorRange } from "../domain/lesson-marks.js";
