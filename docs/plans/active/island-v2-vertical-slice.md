...
- 第三个强调主题、未经登记的资产包、从 donor 项目整目录复制素材 / 渲染代码，以及为两个模式或两个投影各写一套实现。
...
- [ ] 先完成 `Kenney Nature` 自然底盘和连续起伏，再放置 `Fantasy Town` 与 `Space/Modular Space`；逐项登记 Kenney 资产 provenance，并拒绝第三个强调主题。
