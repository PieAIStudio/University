...
| Completed map navigation and the current owner walkthrough | [Map navigation evolution](../../plans/completed/map-navigation-evolution.md): selection, information rails and on-demand shortcuts are implemented and published. Do not restore persistent directory/overview buttons or reopen the approved design; continue from new owner feedback |
