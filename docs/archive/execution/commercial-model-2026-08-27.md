---
id: ARCHIVE-COMMERCIAL-MODEL-2026-08-27
title: Commercial Model Assumptions Recorded 2026-08-27
type: archive
status: archived
canonical: false
owner: human
...
> Historical reasoning, not current pricing research, legal advice, implementation
> status or permission to charge. The current entry is [Commercial Model](../../reference/execution/commercial-model.md).
> This preserves the 2026-08-27 wording, including its assumptions and later
> contradicted claims. In particular, the old grading path, free-sync description,
> catalogue/funnel counts and assertions that provider setup alone blocks charging
> are not current facts. Fees, onboarding, tax and regulatory statements below
> have not been revalidated by this archival operation. Relative links alone have
> been adjusted for this location; the original decision rationale is retained.
...
[player journey v5 §10](../../reference/player-journey/v5/index.html). With that in place
...
- **The selling entity.** Which legal entity opens the Paddle account — the
  ...
  [Payment Backend Gap](../../reference/execution/payment-backend-gap.md).
