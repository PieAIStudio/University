...
新增 26 门不是一次做完的量（46 门 × 约 12 节 ≈ 550 节课）。按证据密度和不可替代性排：

1. **T5 AI 产品工程**（5 门）——最不可替代，别处学不到，真代码最密
2. **T4 真实产品的骨架**（5 门）——所有产品都要
3. **UniversityLocal 支线**（5 门）——学的就是你天天在用的这套东西
4. **T6 让人回来**（5 门）
5. **SupaLuv 支线**（4 门）
6. **T7 交付与质量保障**（2 门）
